export default [
  // 1. Enfermeira Amigável - Sempre pronta para oferecer conselhos de saúde.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/1-enfermeira-amigavel.png",
    facts: {
  ...
  // 2. Historiador Curioso - Apaixonado por fatos históricos interessantes.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/2-historiador-curioso.png",
    facts: {
  ...
  // 3. Chef Criativo - Compartilha receitas e dicas culinárias.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/3-chef-criativo.png",
    facts: {
  ...
  // 4. Aventureiro Viajante - Conta histórias e recomendações de viagens.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/4-aventureiro-viajante.png",
    facts: {
  ...
  // 5. Poeta Inspirador - Cria poesias motivacionais.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/5-poetisa-inspiradora.png",
    facts: {
  ...
  // 6. Cientista Curioso - Explora curiosidades científicas.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/6-cientista-curiosa.png",
    facts: {
  ...
  // 7. Conselheiro do Coração - Oferece conselhos amorosos e de relacionamento.
  {
    id: 7,
    name: "Conselheiro do Coração",
    shortDescription:
      "Guiando através do amor, oferece conselhos sensíveis e perspicazes para nutrir relacionamentos saudáveis e felizes.",
    description:
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/7-conselheira-do-coracao.png",
    facts: {
  ...
  // 8. Astrônomo Amador - Fala sobre eventos astronômicos e estrelas.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/8-astronoma-amadora.png",
    facts: {
  ...
  // 9. Artista Expressivo - Compartilha obras de arte e dicas de criação.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/9-artista-expressivo.png",
    facts: {
  ...
  // 10. Jardineiro Verde - Dá conselhos sobre jardinagem e plantas.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/10-jardineiro-verde.png",
    facts: {
  ...
  // 11. Filósofo Reflexivo - Aborda questões profundas da vida.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/11-filosofo-reflexivo.png",
    facts: {
  ...
  // 12. Músico Melódico - Compartilha músicas e playlists.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/12-musico-melodico.png",
    facts: {
  ...
  // 13. Detetive de Mistérios - Cria enigmas e desafios para resolver.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/13-detive-de-misterios.jpeg",
    facts: {
  ...
  // 14. Entusiasta de Livros - Recomenda leituras e discute literatura.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/14-entusiasta-de-livros.jpeg",
    facts: {
  ...
  // 15. Guia Fitness - Oferece dicas de exercícios e bem-estar.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/15-guia-fitness.jpeg",
    facts: {
  ...
  // 16. Observador de Aves - Compartilha informações sobre pássaros.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/16-observador-de-aves.jpeg",
    facts: {
  ...
  // 17. Conselheiro de Carreira - Ajuda nas escolhas profissionais.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/17-conselheiro-carreira.jpeg",
    facts: {
  ...
  // 18. Gênio da Matemática - Desafia com quebra-cabeças matemáticos.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/18-genio-da-matematica.jpeg",
    facts: {
  ...
  // 19. Guru da Organização - Dá dicas para manter ambientes arrumados.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/19-guru-da-organizacao.jpeg",
    facts: {
  ...
  // 20. Fashionista Elegante - Compartilha tendências e dicas de moda.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/20-fashionista-elegante.jpeg",
    facts: {
  ...
  // 21. Filantropo Compassivo - Envolvido em causas sociais e humanitárias.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/21-filantropo-compassivo.jpeg",
    facts: {
  ...
  // 22. Gamer Estratégico - Discute jogos e compartilha estratégias.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/22-gamer-estrategico.jpeg",
    facts: {
  ...
  // 23. Cineasta Cinéfilo - Recomenda filmes e discute cinema.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/23-cineasta.jpeg",
    facts: {
  ...
  // 24. Gato Aventureiro - Um personagem fictício baseado em um gato curioso.
  {
    ...
    imageUrl:
      "https://raw.githubusercontent.com/elizabetefabri/SAP012-dataverse-chat/3-migracao-do-conjunto-de-dados-do-dataverse/src/images/24-gato-aventureiro.jpeg",
    facts: {
